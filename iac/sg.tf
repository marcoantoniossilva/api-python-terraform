...
resource "aws_vpc_security_group_ingress_rule" "posweb_myapp_allow_http" {
  security_group_id = aws_security_group.posweb_myapp_sg.id
  cidr_ipv4         = "0.0.0.0/0"
  from_port         = 80
  ip_protocol       = "tcp"
...
resource "aws_vpc_security_group_ingress_rule" "posweb_myapp_allow_api" {
  security_group_id = aws_security_group.posweb_myapp_sg.id
  cidr_ipv4         = "0.0.0.0/0"
  from_port         = 5000
  ip_protocol       = "tcp"
...
resource "aws_vpc_security_group_ingress_rule" "posweb_myapp_allow_api2" {
  security_group_id = aws_security_group.posweb_myapp_sg.id
  cidr_ipv4         = "0.0.0.0/0"
  from_port         = 5001
  ip_protocol       = "tcp"
